...
public class MGRS2LatLon extends UTM2LatLon
{
    ...
    public double[] convertMGRSToLatLong(String mgrsString)
    {
        ...
        if ( sep > 0 ) 
        {
            double accuracyBonus = 100000f / (double) Math.pow( 10, sep );
        ...
        return new UTM2LatLon( ).convertUTMToLatLong( String.format( "%d %c %d %d", utmZoneNumber, utmZoneChar, (int)easting, (int)northing ) );
    }
    ...
    protected double getMinNorthing( char zoneLetter ) throws NumberFormatException 
    {
        double northing;
        switch (zoneLetter) 
        {
